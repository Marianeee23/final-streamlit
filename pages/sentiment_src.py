...
st.title("Feelings Analyzer :the_horns:")
st.markdown("""
Welcome to Tumbagahan's Streamlit app for analyzing different feelings.
...
model_filename = './pages/TumbagahansentimentAnalyzerTest_model.sav'
